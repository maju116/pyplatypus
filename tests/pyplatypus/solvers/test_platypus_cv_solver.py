...
class TestPlatypusSolver:
    ...
    def test_run(self, mocker):
        mocker.patch("pyplatypus.solvers.platypus_cv_solver.PlatypusSolver.__init__", return_value=None)
        mocker.patch("pyplatypus.solvers.platypus_cv_solver.PlatypusSolver.train", return_value=None)
