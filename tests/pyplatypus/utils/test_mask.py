from pyplatypus.utils.mask import (
    split_masks_into_binary, concatenate_binary_masks,
...
def test_transform_probabilities_into_binaries(mocker):
    ...
    mocker.patch("pyplatypus.utils.mask.binary_based_on_arg_max", return_value=1)
